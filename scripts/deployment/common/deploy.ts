...
export async function deploy(hnd: string, pools: any[], deployName: string) {
    ...
    const votingEscrowAddress = "0x80123c23eD0A959717f70E246234477F41715db9";

    deployments.VotingEscrow = votingEscrowAddress;
    ...
    const gaugeController: GaugeController = await gaugeControllerFactory.deploy(hnd, votingEscrowAddress);
